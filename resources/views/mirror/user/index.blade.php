...
@section('main-content')
  ...
  @endif
                      ...
                      @foreach ($users as $data)
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="{{route('mirror-user_management.delete', $data->id)}}" onclick="return confirm('Yakin ingin menghapus user ini ?');" class="btn btn-danger btn-sm" name="button">Hapus</a>
                          </td>
                        </tr>
                        @php
                          $no++;
                        ...
                        <div class="modal fade" id="edit_modal{{$data->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <form action="{{route('mirror-user_management.update', $data->id)}}" method="get">
    ...
    <div class="modal fade" id="add_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <form action="{{route('mirror-user_management.store')}}" method="post">
            <div class="modal-header">
