...
@section('js')
  <script type="text/javascript">
    ...
    const daily_url = root_url.concat('/mirror-report/daily/newdatadaily/' + mesin + '/' + form + '/' + mounth);
    ...
    $.ajax({
      ...
      success: function(response){
        ...
        for (var i = 0; i < length; i++) {
          ...
          const exturl = root_url.concat('/mirror-report/daily/detail/'+ response.master_data[j].id);
