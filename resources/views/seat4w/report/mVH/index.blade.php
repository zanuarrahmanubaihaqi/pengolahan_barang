            ...
            <tbody>
              ...
              @foreach ($reports as $data)
                <tr>
                  ...
                  <td>
                    <a class="btn btn-primary btn-sm mr-1" data-toggle="tooltip" data-placement="top" title="Detail" href="{{route('mirror-report.mVH.detail', $data->id)}}">
                      <i class="fas fa-fw fa-eye"></i></a>
                    </button>
                    @if ($data->approval != "")
                      {{-- <a class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Download" href="{{url('mirror-report/mVH/report/'.$data->id)}}">
...
@section('js')
  ...
  $('[name=btn-print]').click(function() {
    var id = $(this).data('id');
    var url = '{{url('mirror-report/mVH/report/')}}'+'/'+id
    printExternal(url);
  })
