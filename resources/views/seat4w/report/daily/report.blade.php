  ...
  <table class="table table-bordered table-sm table-hover" border="1">
    <thead>
      <tr>
        ...
        <td colspan="14" class="text-center align-middle" style="vertical-align: middle;"> <h4><b>Engineering Preventive Maintenance Program & Checklist</b></h4> </td>
      </tr>
      <tr style="font-size:10px;">
        <td colspan="5">Machine Name : {{ $reports['mesin'] }}</td>
        <td rowspan="3" class="text-center align-middle m1-text"><h1><b>DAILY</b></h1></td>
        <td colspan="10">No Dokumen : FR.MNTC.01-144</td>
      </tr>
      <tr style="font-size:10px;">
        <td colspan="5">Proses : Assy Seat</td>
        <td colspan="10">Revisi</td>
      </tr>
      <tr style="font-size:10px;">
        <td colspan="5">Serial : </td>
        <td colspan="10">Efective Start</td>
      </tr>
      <tr style="font-size:10px;">
        <td colspan="16" class="align-middle text-center" style="vertical-align: middle;"><h1><b>Plant Maintenance</b></h1></td>
      </tr>
      <tr style="font-size:10px;">
        <th scope="col">No</th>
    ...
    <tr>
      <td colspan="16" class="bg-secondary"></td>
    </tr>
    <tr style="font-size:10px;">
      <td colspan="6" class="text-center">Total Estimation Time (min)</td>
      <td colspan="10">{{$total_est_time}}</td>
    </tr>
    <tr style="font-size:10px;">
      <td colspan="4" rowspan="3" class="align-middle text-center"></td>
      <td colspan="12" width="15%" class="text-center">{{ $tanggal }} <br> {{ $reports['petugas'] }}</td>
    </tr>
  </table>
