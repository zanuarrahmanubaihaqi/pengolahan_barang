                ...
                <tr>
                  ...
                  <td width="20%" rowspan="5" class="text-center signature">
                    ...
                    @elseif (Auth::guard('adminmirror')->user()->level == 4)
                      <a href="{{route('mirror-report.m3.approve', $reports['id'])}}" class="btn btn-primary btn-sm" name="button">
                  ...
                  <td width="20%" rowspan="5" class="text-center signature">
                    ...
                    @elseif (auth()->user()->level == 4)
                      ...
                      @elseif ($reports['approval2'] == "")
                        Waiting Foreman
                      @else
                        <a href="{{route('report.m3.approve3', $reports['id'])}}" class="btn btn-primary btn-sm" name="button">
                        <i class="fas fa-fw fa-edit"></i> Setujui</a>
                      @endif
                    @endif
                  </td> --}}
...
@section('js')
  ...
  $('#btn-print').click(function() {
    var id = $(this).data('id');
    printExternal(window.location.origin+'/maintenance-aski2/mirror-report/m3/report/'+id);
  })
