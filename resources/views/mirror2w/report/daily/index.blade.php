                    ...
                    <tbody id="body_table_daily">
                      ...
                      @foreach ($reports as $data)
                        <tr>
                          ...
                          <td>
                            <a href="{{url('mirror2w-report/daily/detail/'.$data->id)}}" class="btn btn-primary btn-sm" name="button">Detail</a>
                          </td>
                        </tr>
                        @php
                          $no++;
...
@section('js')
  <script type="text/javascript">
    ...
    const daily_url = root_url.concat('/mirror2w-report/daily/newdatadaily/' + mesin + '/' + mounth);
    ...
    $.ajax({
      ...
      success: function(response){
        ...
        for (var i = 0; i < length; i++) {
          ...
          const exturl = root_url.concat('/mirror2w-report/daily/detail/'+ response.master_data[j].id);
          code = response.master_data[j].kode;
            konten += "<tr>";
                        ...
                        "</td>"+
                        "<td>"+
                          response.reports[i].notem11 +
                        "</td>"+
                        "<td>"+
                          response.reports[i].notem12 +
                        "</td>"+
                        "<td>"+
                          response.reports[i].notem13 +
                        "</td>";
                        if (j == 0) {
                          konten +=
                          "<td rowspan='" + mlength + "'>"+
