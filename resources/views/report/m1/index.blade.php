            ...
            <tbody>
              ...
              @foreach ($reports as $data)
                <tr>
                  ...
                  <td>
                    <a class="btn btn-primary btn-sm mr-1" data-toggle="tooltip" data-placement="top" title="Detail" href="{{route('report.m1.detail', $data->id)}}">
...
@section('js')
  ...
  $('[name=btn-print]').click(function() {
    console.log("hallo");
    var id = $(this).data('id');
    var url = '{{url('report/m1/report/')}}'+'/'+id
    printExternal(url);
  })
