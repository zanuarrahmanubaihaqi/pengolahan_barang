...
<div class="row">
  <div class="col">
    <h1 class="h3 mb-4 text-gray-800">Very High Report {{$nama_bulan}} - {{$tahun}}</h1>
  </div>
                ...
                <tr>
                  ...
                  {{-- <td width="20%" rowspan="5" class="text-center signature">
                    ...
                    @elseif (auth()->user()->level == 2)
                      <a href="{{route('report.mVH.approve1', $reports['id'])}}" class="btn btn-primary btn-sm" name="button">
                  ...
                  <td width="20%" rowspan="5" class="text-center signature">
                    ...
                    @elseif (auth()->user()->level == 3)
                      @if ($reports['approval1'] == "")
                        <i>Waiting Leader</i>
                      @else
                        <a href="{{route('report.mVH.approve2', $reports['id'])}}" class="btn btn-primary btn-sm" name="button">
                        <i class="fas fa-fw fa-edit"></i> Setujui</a>
                      @endif
                    @endif
                  </td> --}}
...
@section('js')
  ...
  $('#btn-print').click(function() {
    var id = $(this).data('id');
    printExternal(window.location.origin+'/maintenance-aski2/report/mVH/report/'+id);
  })
