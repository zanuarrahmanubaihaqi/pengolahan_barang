            ...
            <tbody>
              ...
              @foreach ($reports as $data)
                <tr>
                  ...
                  <td>
                    <a class="btn btn-primary btn-sm mr-1" data-toggle="tooltip" data-placement="top" title="Detail" href="{{route('report.m6.detail', $data->id)}}">
                      <i class="fas fa-fw fa-eye"></i></a>
                    </button>
                    @if ($data->approval1 != "")
                      {{-- <a class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Download" href="{{url('report/m6/report/'.$data->id)}}">
...
@section('js')
  ...
  $('[name=btn-print]').click(function() {
    var id = $(this).data('id');
    var url = '{{url('report/m6/report/')}}'+'/'+id
    printExternal(url);
  })
