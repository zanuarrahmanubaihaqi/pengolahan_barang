                ...
                <tr>
                  ...
                  {{-- <td width="20%" rowspan="5" class="text-center signature">
                    ...
                    @elseif (auth()->user()->level == 2)
                      <a href="{{route('report.m6.approve1', $reports['id'])}}" class="btn btn-primary btn-sm" name="button">
...
@section('js')
  ...
  $('#btn-print').click(function() {
    var id = $(this).data('id');
    printExternal(window.location.origin+'/maintenance-aski2/report/m6/report/'+id);
  })
