  ...
  <table class="table table-bordered table-sm table-hover" border="1">
    <thead>
      ...
      <tr style="font-size:10px;">
        <td colspan="5">Machine Name : SEAT ASSY 2W LINE {{ $reports['mesin'] }}</td>
      ...
      <tr style="font-size:10px;">
        <td colspan="10" width="55%" class="align-middle text-center" style="vertical-align: middle;"><h1><b>Plant Maintenance</b></h1></td>
    ...
    <tr style="font-size:10px;">
      ...
      <td colspan="3">{{$total_est_time}}</td>
    </tr>
    <tr style="font-size:10px;">
      <td colspan="4" rowspan="3" class="align-middle text-center"></td>
      <td colspan="6" width="15%" class="text-center">{{ $tanggal }} <br> {{ $reports['petugas'] }}</td>
    </tr>
    <!-- <tr style="font-size:10px;">
