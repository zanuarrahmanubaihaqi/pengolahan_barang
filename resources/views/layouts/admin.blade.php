...
<head>
    ...
    <title>{{ config('app.name', 'Gotrans - Pengelolaan') }}</title>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <div class="sidebar-brand-text mx-3">Gotrans - Pengelolaan</div>
        </a>
        ...
        <li class="nav-item {{Request::segment(1) === 'report' ? 'active' : null}}">
          ...
          <div id="report" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="{{route('lokasi.index')}}">Data Lokasi</a>
