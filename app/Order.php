...
class Order extends Model
{
    ...
    public static function getOrderData() {
        $data = DB::table('order')
                ->select('order_id', 'a.name', 'a.nik', 'e.dept_name', 'b.brg_nama', 'b.brg_stok', 'c.satuan_ket', 'd.lokasi_code', 'd.lokasi_ket')
    ...
    public static function getOrderDataById() {
        $data = DB::table('order')
                ...
                ->groupBy('order_id', 'a.name', 'a.nik', 'e.dept_name', 'b.brg_nama', 'b.brg_stok', 'c.satuan_ket', 'd.lokasi_code', 'd.lokasi_ket')->get();
        return $data;
    }
